...
var Vendor = /** @class */ (function (_super) {
    ...
    __decorate([
        typeorm_1.OneToMany(function () { return Product_1.Product; }, function (product) { return product.vendor; }, {
            onDelete: "CASCADE",
            onUpdate: "CASCADE",
        }),
    ...
    __decorate([
        typeorm_1.OneToMany(function () { return Stock_1.Stock; }, function (stocks) { return stocks.vendor; }, {
            onDelete: "CASCADE",
            onUpdate: "CASCADE",
        }),
        __metadata("design:type", Array)
